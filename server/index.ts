...
// Simple log function (no longer from vite.ts)
...
(async () => {
  ...
  // Assets are served by Next.js from frontend/public/attached_assets
  // The frontend (Next.js) will be served separately
  ...
  server.listen(port, "0.0.0.0", () => {
    ...
    log(`CORS enabled for: ${frontendUrl}`);
  });
})();
