...
export default function Experiences() {
  useEffect(() => {
    ...
    const description =
      "Discover every type of bowling experience across the U.S.—cosmic bowling, birthday parties, costs by city, arcades, late-night lanes, and more.";
    ...
    // Canonical URL
    const canonicalUrl = window.location.origin + "/experiences";
      ...
      <div className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            >
              Explore All Bowling Experiences (2025)
            </h1>
